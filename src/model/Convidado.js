...
class Convidado {
    constructor(CONV_TITU_CODIGO, CONV_TITU_NOME, SOCI_CODIGO, CONV_TITU_TIPO, CONV_TITU_CPFCNPJ){
        this.CONV_TITU_CODIGO = CONV_TITU_CODIGO;
    ...
    async save(){
        ...
        .returning('*')
        .insert({
            CONV_TITU_CODIGO : this.CONV_TITU_CODIGO,
